function heatmap = simplenn_occlusion(net, im_, box, varargin)
...
% the terms of the BSD license (see the LICENCE file).
    ...
    heatmap = occlude(net, im_, box, score, measureLayer, measureFilter, boxColor, sizesAndStrides{1:end});
end

function heatmap = occlude(net, im_, box, score, measureLayer, measureFilter, boxColor, varargin)
    ...
    for k = 1:4:length(varargin)
        ...
        tempHeat = compute_heat(net, im_, box, score, measureLayer, measureFilter, boxColor, varargin{k}, varargin{k+1}, varargin{k+2}, varargin{k+3});
...
function heatmap = compute_heat(net, im_, box, score, measureLayer, measureFilter, boxColor, sizeW, strideW, sizeH, strideH)
